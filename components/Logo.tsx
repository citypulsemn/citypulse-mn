export function Logo() {
  return (
    <a className="brand" href="/" aria-label="City Pulse MN — home">
      <svg
        width="44"
        height="40"
        viewBox="0 0 80 70"
      ...
      {/* The stylized letterforms read as "CITY PULSEM N" to screen readers and
          crawlers, so they're presentation-only; the link's aria-label carries
          the real name. */}
