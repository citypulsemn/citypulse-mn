...
describe("selectors", () => {
  ...
  it("kindsWithPlaces lists only seeded kinds, with counts and open state", () => {
    ...
    expect(Object.keys(bySlug).sort()).toEqual(["beach", "disc-golf", "dog-park", "farmers-market", "garden", "golf-course", "indoor-playground", "museum", "nature-center", "orchard", "park", "playground", "pool", "rink", "ski-hill", "sledding", "splash-pad"]);
