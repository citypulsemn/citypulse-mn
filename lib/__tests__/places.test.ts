...
describe("selectors", () => {
  ...
  it("kindsWithPlaces lists only seeded kinds, with counts and open state", () => {
    ...
    expect(Object.keys(bySlug).sort()).toEqual(["beach", "disc-golf", "dog-park", "farmers-market", "garden", "golf-course", "museum", "nature-center", "park", "playground", "pool", "rink", "ski-hill", "sledding", "splash-pad"]);
