...
describe("selectors", () => {
  ...
  it("kindsWithPlaces lists only seeded kinds, with counts and open state", () => {
    ...
    expect(Object.keys(bySlug).sort()).toEqual(["beach", "disc-golf", "dog-park", "farmers-market", "golf-course", "nature-center", "park", "playground", "pool", "rink", "sledding", "splash-pad"]);
